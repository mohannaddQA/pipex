...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   setup_io_operations_bonus.c                        :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: mabuqare  <mabuqare@student.42amman.com    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/10/27 18:14:34 by mabuqare          #+#    #+#             */
/*   Updated: 2025/11/08 13:58:19 by mabuqare         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	redirect_input(t_pipex *p_info)
{
	...
	close(p_info->pipe_fds[WRITE]);
	redirection_status = dup2(p_info->pipe_fds[READ], STDIN_FILENO);
...
int	setup_output_file(t_pipex *p_info)
{
	...
	close(p_info->pipe_fds[WRITE]);
	if (p_info->here_doc_enabled)
		p_info->file_fds[1] = open(p_info->out_file,
